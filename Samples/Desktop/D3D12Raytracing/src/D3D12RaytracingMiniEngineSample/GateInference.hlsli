...
// Make the buffer type dynamic so both shaders can share this math
#ifndef MLP_BUFFER_TYPE
#define MLP_BUFFER_TYPE ByteAddressBuffer
#endif
...
// REMOVED 'inout' and replaced type with macro
float4 loadNNParameter(const uint index, MLP_BUFFER_TYPE nnParameters)
{
